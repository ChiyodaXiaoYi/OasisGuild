...
public final class SetMaxMemberCommand extends AbstractSubCommand {

    public static final ISubCommand INSTANCE = new SetMaxMemberCommand();

    private SetMaxMemberCommand() {
        super("setMaxMember", null);
    }
    ...
    public boolean onCommand(CommandSender sender, List<String> args) {
        ...
        int maxMember;
        try {
            maxMember = Integer.parseInt(args.get(1));
        } catch (Exception e) {
